...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<polyamorous>.freeze, ["~> 1.1"])
      ...
      s.add_development_dependency(%q<mysql2>.freeze, ["= 0.3.14"])
      ...
      s.add_dependency(%q<polyamorous>.freeze, ["~> 1.1"])
      ...
      s.add_dependency(%q<mysql2>.freeze, ["= 0.3.14"])
